...
def main() -> None:
    ...
    if args.tx_tone:
        ...
        tx_thread.start()
        # See docs/nr_waveform_method.md: 0.5s isn't enough for the threaded
        # TX loop to clear its startup underrun transient (~1-1.5s), which
        # caused spuriously low/unstable SNR on early captures. 2.5s clears it.
        time.sleep(2.5)
